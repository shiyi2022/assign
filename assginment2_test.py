...
###Only a single python script is allowed in the deliverable, so I choose to submit the python script of the test dataset
...
#Sample classification, divided into two categories according to "is_impossible"
# is_impossible=True
...
print("Split long text into short text as required********************")

#Split long text into short text as required
...
# Split long text for impossible samples
a=data_ture.rdd
impossible_samples=a.flatMap(split_rdd)
impossible_samples.count()

#Split long text for  posivle samples + positive samples
aaa=data_false.rdd
...
# Classification-possible negative samples
...
#Balance sample：impossible_samples\positive_samples\possible_negative_samples

# positive_samples
# positive_samples are all selected
...
# positive_samples
#First, according to the positive sample data set，first establish a dictionary: 
#the key is each question of each contract (question id) , and the value is the number of positive samples
#Then, in the original possible negative sample set, select possible negative samples for each contract and each question
#if it is the same as the key , select the same number of samples as the value
...
##First get the average number of each question from the positive set
##Then Select the same number of impossible negative samples for the same problem for each contract
...
#Combine three types of samples
